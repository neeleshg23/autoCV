...
\\ {\em USC Ming Hsieh Department of ECE - Data Science Lab} & \hfill {\em April 2023 - Present}\\
\multicolumn{2}{@{}X@{}}{
\begin{minipage}[t]{\linewidth}
    \begin{itemize}[nosep,after=\strut, leftmargin=1em, itemsep=3pt]
        \item[--] Engineered and optimized cutting-edge ML-based prefetching methods (Reinforcement Learning, Product Quantization, Clustering, Knowledge Distillation) after reviewing relevant literature, leading to a cache coverage improvement of over 30\%.
        \item[--] Employed PyTorch, scikit-learn, and C to develop innovative ML-based prefetching techniques, seamlessly incorporating them into a microarchitecture simulation framework.
        \item[--] First authored conference paper \textit{PaCKD: Pattern-Clustered Knowledge Distillation for Compressing Memory Access Prediction Models} to appear in Proceedings of 2023 IEEE High Performance Extreme Computing conference.
    \end{itemize}
\end{minipage}
}
\\
...
\begin{minipage}[t]{\linewidth}
    \begin{itemize}[nosep,after=\strut, leftmargin=1em, itemsep=3pt]
        \item[--] Wrote bash scripts to scrape and analyze 24.6K YouTube ads for young children and found 26.9\% include inappropriate content with 97\% accuracy.
        \item[--] Automated F1 score calculation using NumPy, helping improve hyperparameterization in the PCA algorithm for anomaly detection in network traffic data, resulting in an increase in F1 by 15\%.
        \item[--] Employed the Enron Corpus dataset to meticulously annotate 2.5K emails and train a state-of-the-art NLP model proficient in identifying and categorizing spam and phishing content.
    \end{itemize}
\end{minipage}
}
\\
...
\begin{minipage}[t]{\linewidth}
    \begin{itemize}[nosep,after=\strut, leftmargin=1em, itemsep=3pt]
        \item[--] Developed a high-accuracy machine learning system for handwritten digit recognition using Python, TensorFlow, Keras, and a Convolutional 2D Neural Network architecture trained on CUDA Cores.
