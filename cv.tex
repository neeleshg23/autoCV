...
\\ {\em USC Ming Hsieh Department of ECE - Parallel Computing/Data Science Lab} & \hfill {\em January 2023 - Present}\\
\multicolumn{2}{@{}X@{}}{
...
\begin{minipage}[t]{\linewidth}
\begin{itemize}[nosep,after=\strut, leftmargin=1em, itemsep=3pt]
\item[--] Develop novel computer architecture approaches to tackle post-Moore's era memory subsystems overhead using machine learning to better cache utilization compared to traditional rule-based prefetchers.
...
\item[--] Reduced arithmetic operations during inference by over 90\% for table-lookup approximated operations.
