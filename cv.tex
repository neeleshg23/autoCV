...
\begin{minipage}[t]{\linewidth}
    \begin{itemize}[nosep,after=\strut, leftmargin=1em, itemsep=3pt]
        \item[--] Collaborate with a team of PhD students under the guidance of Prof. Viktor K. Prasanna to optimize deep neural networks as hardware-viable prefetchers, leveraging advanced architectural optimizations.
        \item[--] Conduct PyTorch experiments to explore knowledge distillation techniques in ML-based prefetchers, achieving a remarkable 99\% compression rate while ensuring acceptable accuracy loss.
    \end{itemize}
\end{minipage}
}
\\
