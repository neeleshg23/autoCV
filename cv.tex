...
\\ {\em USC Ming Hsieh Department of ECE - Data Science/Parallel Computing Lab} & \hfill {\em April 2023 - Present}\\
\multicolumn{2}{@{}X@{}}{
\begin{minipage}[t]{\linewidth}
    \begin{itemize}[nosep,after=\strut, leftmargin=1em, itemsep=3pt]
        ...
        \item[--] Crafted sophisticated ML-based prefetching techniques utilizing PyTorch, CUDA, scikit-learn, and C, seamlessly incorporating them into a microarchitecture simulation framework, ChampSim.
        \item[--] First-authored paper titled \textit{PaCKD: Pattern-Clustered Knowledge Distillation for Compressing Memory Access Prediction Models}, exploring tradeoffs between compression, memory access prediction, and latency, to appear in \textit{2023 IEEE High Performance Extreme Computing (HPEC)} conference.
    \end{itemize}
\end{minipage}
}
\\
