...
\begin{minipage}[t]{\linewidth}
    \begin{itemize}[nosep,after=\strut, leftmargin=1em, itemsep=3pt]
        ...
        \item[--] First-authored paper titled ``PaCKD: Pattern-Clustered Knowledge Distillation for Compressing Memory Access Prediction Models,'' exploring tradeoffs between compression, memory access prediction, and latency, to appear in \textit{2023 IEEE High Performance Extreme Computing (HPEC)} conference.
    \end{itemize}
\end{minipage}
}
\\
